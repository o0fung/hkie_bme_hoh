...
class SettingsScene(Scene):
    def __init__(
        ...
        set_dynamic_noise_floor_window_seconds: Callable[[float], None],
        set_dynamic_noise_floor_percentile: Callable[[float], None],
        set_dynamic_noise_floor_alpha: Callable[[float], None],
        set_dynamic_noise_floor_margin_percent: Callable[[float], None],
        ...
        stepper_labels = [
            ...
            ("Noise Floor Win s", "{:.1f}", init_values.get("dynamic_noise_floor_window_seconds", 3.0)),
            ("Noise Floor Pctl", "{:.0f}", init_values.get("dynamic_noise_floor_percentile", 20.0)),
            ("Noise Floor Alpha", "{:.2f}", init_values.get("dynamic_noise_floor_alpha", 0.05)),
            ("Noise Floor Margin %", "{:.0f}%", init_values.get("dynamic_noise_floor_margin_percent", 5.0)),
        ]
        max_label_width = 0
        ...
        self.step_dynamic_noise_floor_window = NumericStepper(
            "Noise Floor Win s",
            (x0, y0 + s(950)),
            self.font,
            init_values.get("dynamic_noise_floor_window_seconds", 3.0),
            0.1,
            0.5,
            20.0,
            fmt="{:.1f}",
            on_change=set_dynamic_noise_floor_window_seconds,
            button_x=button_x,
            button_w=stepper_button_w,
            button_h=stepper_button_h,
            button_gap=stepper_button_gap,
        ...
        self.step_dynamic_noise_floor_percentile = NumericStepper(
            "Noise Floor Pctl",
            (x0, y0 + s(1000)),
            self.font,
            init_values.get("dynamic_noise_floor_percentile", 20.0),
            1.0,
            1.0,
            50.0,
            fmt="{:.0f}",
            on_change=set_dynamic_noise_floor_percentile,
            button_x=button_x,
            button_w=stepper_button_w,
            button_h=stepper_button_h,
            button_gap=stepper_button_gap,
        ...
        self.step_dynamic_noise_floor_alpha = NumericStepper(
            "Noise Floor Alpha",
            (x0, y0 + s(1050)),
            self.font,
            init_values.get("dynamic_noise_floor_alpha", 0.05),
            0.01,
            0.0,
            1.0,
            fmt="{:.2f}",
            on_change=set_dynamic_noise_floor_alpha,
            button_x=button_x,
            button_w=stepper_button_w,
            button_h=stepper_button_h,
            button_gap=stepper_button_gap,
        ...
        self.step_dynamic_noise_floor_margin = NumericStepper(
            "Noise Floor Margin %",
            (x0, y0 + s(1100)),
            self.font,
            init_values.get("dynamic_noise_floor_margin_percent", 5.0),
            1,
            0,
            50,
            fmt="{:.0f}%",
            on_change=set_dynamic_noise_floor_margin_percent,
            button_x=button_x,
            button_w=stepper_button_w,
            button_h=stepper_button_h,
            button_gap=stepper_button_gap,
        ...
        self._steppers = [
            ...
            self.step_dynamic_noise_floor_window,
            self.step_dynamic_noise_floor_percentile,
            self.step_dynamic_noise_floor_alpha,
            self.step_dynamic_noise_floor_margin,
